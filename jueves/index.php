...
$lista_horarios = $horarios->getHorarios('Jueves'); // Se mantiene 'Jueves' como día por defecto
...
<head>
    ...
    <title>Sistema de Horarios de Clases - Jueves</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="mb-0 mt-2">Gestión de clases del día Jueves</p>
                </div>
                    ...
                    <div class="card-body p-0">
                        <?php if (empty($lista_horarios)): ?>
                            <div class="text-center p-5">
                                ...
                                <p class="text-muted">No hay horarios registrados para el día Jueves.</p>
                            </div>
                        <?php else: ?>
