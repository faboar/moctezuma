...
$lista_horarios = $horarios->getHorarios('Miercoles'); // Se mantiene 'Miercoles' como día por defecto
...
<head>
    ...
    <title>Sistema de Horarios de Clases - Miercoles</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-8">
                    ...
                    <p class="mb-0 mt-2">Gestión de clases del día Miercoles</p>
                </div>
                    ...
                    <div class="btn-group">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="../lunes/index.php">
                                <i class="fas fa-calendar-day me-2 text-danger"></i>Lunes
                            </a></li>
                            <li><a class="dropdown-item" href="../martes/index.php">
                                <i class="fas fa-calendar-day me-2 text-info"></i>Martes
                            </a></li>
                    ...
                    <div class="card-body p-0">
                        <?php if (empty($lista_horarios)): ?>
                            <div class="text-center p-5">
                                ...
                                <p class="text-muted">No hay horarios registrados para el día Miercoles.</p>
                            </div>
                        <?php else: ?>
