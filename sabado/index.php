...
$lista_horarios = $horarios->getHorarios('Sabado'); // Se mantiene 'Sabado' como día por defecto
...
<head>
    ...
    <title>Sistema de Horarios de Clases - Sabado</title>
                    ...
                    <div class="card-body p-0">
                        <?php if (empty($lista_horarios)): ?>
                            <div class="text-center p-5">
                                ...
                                <p class="text-muted">No hay horarios registrados para el día Sabado.</p>
                            </div>
                        <?php else: ?>
